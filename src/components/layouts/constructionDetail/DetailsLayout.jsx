        ...
        <div className="flex flex-col gap-2 xl:w-[60%]">
            {
                isLoading ?
                    ...
                    <div className="font-semibold text-lg ">
                        ...
                        <h1 className=" xl:text-xl">{data?.design_name ? data?.design_name : data?.name}</h1>
                        ...
                        <h4 className="xl:text-2xl xl:font-bold ">{Rupiah(data?.total_price ? data?.total_price : data.unit_price)}</h4>
                    </div>
            }
            <p className="text-sm text-neutral-600 xl:text-base">{data?.descriptions ? data?.descriptions : data?.desc}</p>
            <div className={`my-3 ${data?.brand ? "hidden" : ""}`}>
