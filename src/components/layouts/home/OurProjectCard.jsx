...
export function OurProjectCard({ location, image, date }) {
    ...
    return (
        <>
            <div className="xl:w-[30rem] h-52 xl:h-64 rounded-3xl p-5 flex flex-col justify-between"
                style={{
            ...
            >
                ...
                <div className="absolute inset-0 flex items-center xl:w-[30rem] rounded-3xl justify-center bg-black bg-opacity-50 opacity-0 hover:opacity-100 transition-opacity duration-300">
